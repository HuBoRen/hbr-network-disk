...
public class AliyunUtils {
    ...
    private static final String accessKeyId ="LTAI4G4DvJ5ToxspXDwLcNQy"; //TODO: 这里要写成你自己生成的
    private static final String accessKeySecret ="n61imNUoXLWCiEdOP7YhJloqDUYbkj";
