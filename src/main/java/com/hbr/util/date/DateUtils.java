...
//    }
    ...
    public static String getYesTodayStr() {
        ...
        return DateUtils.format(date, DateUtils.FMT_DATE);
    }
    ...
    public static void main(String[] args) {
       Date date = DateUtils.parse("2018-05-22 23:50:1", "yyyy-MM-dd HH:mm:ss");
        Date date2 = DateUtils.parse("2018-05-24 19:52:11", "yyyy-MM-dd HH:mm:ss");

        long diff = diffDays(date, date2);

        for (int i = 0; i <= diff; i++) {
            System.out.println(DateUtils.format(DateUtils.getBeforeNDayDate(i,date2),DateUtils.FMT_DATE));
        }
//        System.out.println(diffDays(date, date2));
//        System.out.println(DateUtil.getYesToday());
//
//        System.out.println(DateUtil.format(DateUtil.parse("2018-08-13T10:59:11.084+08:00",DateUtil.FMT_DATE),DateUtil.FMT_DATE));
//
//        System.out.println(DateUtil.parse("2018-08-13T10:59:11.084+08:00",DateUtil.FMT_DATE));
//
//        String soap = " project=  ttt    addd dd fff";
//        String regex = ".*project\\s*=\\s+(.*?)\\s+\\S*";
//
//        System.out.println( Arrays.toString(getSubUtil(soap, regex).toArray()));
    ...
    public static List<String> getIntervalTimeList(String start,String end,int interval){
        Date startDate = parse(start,FMT_DATE);
        Date endDate = parse(end,FMT_DATE);
        List<String> list = new ArrayList<>();
        while(startDate.getTime()<=endDate.getTime()){
            list.add(format(startDate,FMT_DATE));
            Calendar calendar = Calendar.getInstance();
            calendar.setTime(startDate);
            calendar.add(Calendar.DATE,interval);
            if(calendar.getTime().getTime()>endDate.getTime()){
                if(!startDate.equals(endDate)){
                    list.add(format(endDate,FMT_DATE));
                }
